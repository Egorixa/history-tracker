...
namespace Data.Migrations
{
    ...
    [Migration("20260521190222_AddSiteChat")]
    partial class AddSiteChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.SiteMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Core.Entities.SiteThread", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ChannelId", "LastMessageAt");

                    b.HasIndex("ChannelId", "UrlHash");

                    b.ToTable("site_threads", (string)null);
                });
            ...
            modelBuilder.Entity("Core.Entities.SiteMessage", b =>
                {
                    ...
                    b.HasOne("Core.Entities.SiteThread", "Thread")
                        .WithMany("Messages")
